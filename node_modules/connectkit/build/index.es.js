...
const isFrontier = () => {
    if (typeof window === 'undefined')
        return false;
    const { ethereum } = window;
    const isFrontier = Boolean(ethereum === null || ethereum === void 0 ? void 0 : ethereum.isFrontier);
    if (isFrontier)
        return true;
    return false;
};
const isTrust = () => {
    ...
    return !!((ethereum === null || ethereum === void 0 ? void 0 : ethereum.isTrust) ||
        ...
        ((_a = window.trustWallet) === null || _a === void 0 ? void 0 : _a.isTrust) ||
        ((_b = window.trustwallet) === null || _b === void 0 ? void 0 : _b.isTrust));
};
const isTokenPocket = () => {
    if (typeof window === 'undefined')
        return false;
    const { ethereum } = window;
    return Boolean(ethereum === null || ethereum === void 0 ? void 0 : ethereum.isTokenPocket);
};
const isTalisman = () => {
    if (typeof window === 'undefined')
        return false;
...
const isFordefi = () => {
    if (typeof window === 'undefined')
        return false;
    const { ethereum } = window;
    return Boolean(ethereum === null || ethereum === void 0 ? void 0 : ethereum.isFordefi);
};
...
const CONNECTKIT_VERSION = '1.5.0';
